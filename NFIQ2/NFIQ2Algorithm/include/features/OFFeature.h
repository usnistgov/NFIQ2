...
static double OFHISTLIMITS[9] = { 1.715e-2, 3.5e-2, 5.57e-2, 8.1e-2, 1.15e-1, 1.718e-1, 2.569e-1, 4.758e-1, 7.48e-1 };

class OFFeature : BaseFeature
{

  public:
    OFFeature( bool bOutputSpeed, std::list<NFIQ::QualityFeatureSpeed>& speedValues )
      : BaseFeature( bOutputSpeed, speedValues )
      , blocksize( 16 ), slantedBlockSizeX( 32 ), slantedBlockSizeY( 16 ), threshold( 0.1 ), angleMin( 4.0 )
    {
    };
    virtual ~OFFeature();
  ...
  private:
    ...
    double threshold;      /*!< Threshold for differentiating foreground/background blocks */
    double angleMin;       /*!< Minimum angle change inclusion in the quality measure */
};
