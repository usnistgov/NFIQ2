...
FingerprintImageData::FingerprintImageData(
    const uint8_t* pData, uint32_t dataSize, uint32_t imageWidth,
...
FingerprintImageData::removeWhiteFrameAroundFingerprint() {
  ...
  NFIQ::FingerprintImageData localFingerprintImage(
      this->m_ImageWidth, this->m_ImageHeight, this->m_FingerCode,
      this->m_ImageDPI);
  // copy data now
  ...
  // start from top of image and find top row index that is already part of the
  // fingerprint image
  int topRowIndex = 0;
  ...
  // start from bottom of image and find bottom row index that is already part
  ...
  // start from left of image and find left index that is already part of the
  // fingerprint image
  int leftIndex = 0;
  ...
  // start from right of image and find right index that is already part of the
  // fingerprint image
