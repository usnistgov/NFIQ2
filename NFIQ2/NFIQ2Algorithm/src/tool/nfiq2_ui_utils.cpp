...
NFIQ2UI::printUsage() {
  ...
  std::cout << "                               Welcome to NFIQ2"
            << "\n\n";
  std::cout << "      Please provide individual files or directories to the "
               "command line."
            << "\n";
  std::cout
  ...
  std::cout << "-v: Displays individual quality score information about each "
               "processed image"
            << "\n";
  ...
  std::cout << "\nVersion Info\n------------\n"
            ...
            << "\n"
               "NFIQ 2: "
            << NFIQ::Version::Pretty << " (Date: " << NFIQ::Version::BuildDate
