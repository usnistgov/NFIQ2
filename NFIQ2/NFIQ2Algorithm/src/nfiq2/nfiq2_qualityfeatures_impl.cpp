...
// for (const auto &feature : features) {
// 	if (feature->getModuleName().compare("NFIQ2_FDA") == 0) {
// 		const std::shared_ptr<FDAFeature> fdaFeatureModule =
// 		    std::dynamic_pointer_cast<FDAFeature>(feature);

// 		std::vector<NFIQ::QualityFeatureResult> fdaFeatures =
// 		    fdaFeatureModule->getFeatures();

// 		for (auto result : fdaFeatures) {
// 			if (result.returnCode == 0) {
// 				featureVector.push_back(
// 				    result.featureData);
// 			} else {
// 				result.featureData.featureDataDouble =
// 				    0;
// 				featureVector.push_back(
// 				    result.featureData);
// 			}
...
// 		}
// 	} else if (feature->getModuleName().compare(
// 		       "NFIQ2_FJFXPos_MinutiaeQuality") == 0) {
// 		const std::shared_ptr<FJFXMinutiaeQualityFeature>
// 		    fjfxMinQualFeatureModule =
// 			std::dynamic_pointer_cast<
// 			    FJFXMinutiaeQualityFeature>(feature);

// 		std::vector<NFIQ::QualityFeatureResult>
// 		    fjfxMinQualFeatures =
// 			fjfxMinQualFeatureModule->getFeatures();

// 		for (auto &result : fjfxMinQualFeatures) {
// 			if (result.returnCode == 0) {
// 				featureVector.push_back(
// 				    result.featureData);
// 			} else {
...
// 			}
// 		}
// 	} else if (feature->getModuleName().compare("NFIQ2_LCS") == 0) {
// 		const std::shared_ptr<LCSFeature> lcsFeatureModule =
// 		    std::dynamic_pointer_cast<LCSFeature>(feature);

// 		std::vector<NFIQ::QualityFeatureResult> lcsFeatures =
// 		    lcsFeatureModule->getFeatures();

// 		for (auto &result : lcsFeatures) {
// 			if (result.returnCode == 0) {
// 				featureVector.push_back(
// 				    result.featureData);
// 			} else {
...
// 			}
// 		}
// 	} else if (feature->getModuleName().compare("NFIQ2_Mu") == 0) {
...
// 		}
// 	} else if (feature->getModuleName().compare(
// 		       "NFIQ2_OCLHistogram") == 0) {
// 		const std::shared_ptr<OCLHistogramFeature>
// 		    oclFeatureModule =
// 			std::dynamic_pointer_cast<OCLHistogramFeature>(
// 			    feature);

// 		std::vector<NFIQ::QualityFeatureResult> oclFeatures =
// 		    oclFeatureModule->getFeatures();

// 		for (auto &result : oclFeatures) {
// 			if (result.returnCode == 0) {
// 				featureVector.push_back(
// 				    result.featureData);
// 			} else {
...
// 			}
// 		}
// 	} else if (feature->getModuleName().compare("NFIQ2_OF") == 0) {
// 		const std::shared_ptr<OFFeature> ofFeatureModule =
// 		    std::dynamic_pointer_cast<OFFeature>(feature);

// 		std::vector<NFIQ::QualityFeatureResult> ofFeatures =
// 		    ofFeatureModule->getFeatures();

// 		for (auto &result : ofFeatures) {
// 			if (result.returnCode == 0) {
// 				featureVector.push_back(
// 				    result.featureData);
// 			} else {
...
// 	} else if (feature->getModuleName().compare(
// 		       "NFIQ2_QualityMap") == 0) {
// 		const std::shared_ptr<QualityMapFeatures>
// 		    qmFeatureModule =
// 			std::dynamic_pointer_cast<QualityMapFeatures>(
// 			    feature);

// 		std::vector<NFIQ::QualityFeatureResult> qmFeatures =
// 		    qmFeatureModule->getFeatures();

// 		for (auto &result : qmFeatures) {
// 			if (result.returnCode == 0) {
// 				featureVector.push_back(
// 				    result.featureData);
// 			} else {
...
// 		}
// 	} else if (feature->getModuleName().compare(
// 		       "NFIQ2_RVUPHistogram") == 0) {
// 		const std::shared_ptr<RVUPHistogramFeature>
// 		    rvupFeatureModule =
// 			std::dynamic_pointer_cast<RVUPHistogramFeature>(
// 			    feature);

// 		std::vector<NFIQ::QualityFeatureResult> rvupFeatures =
// 		    rvupFeatureModule->getFeatures();

// 		for (auto &result : rvupFeatures) {
// 			if (result.returnCode == 0) {
// 				featureVector.push_back(
// 				    result.featureData);
// 			} else {
